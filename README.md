...
We have provided the experimental scripts for the CMAPSS dataset in the corresponding section of the folder.To reproduce the results, you can run the following shell code.

The running script of DiDA_Net on three datasets
```bash
 ./DiDA_Net/scripts/CMAPSS_train.sh
```
## Results
